document.addEventListener('DOMContentLoaded', function() {
    ...
    addExpertProfile('Gossi Coulibal0y'', 'Geopolitical Tech Expert', 'Expert in geopolitics with a focus on technological advancements in Central Africa.', 'Geopolitics (Expert),Tech Development (Advanced),Policy Analysis (Intermediate)', 'Geopolitical Forums,African Tech Networks', 'Tech Policy in Central Africa,Geopolitical Analysis Projects');
